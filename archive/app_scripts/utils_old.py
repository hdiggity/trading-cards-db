...
# Removed old accuracy, learning, and tcdb imports - simplified extraction
...
def build_legacy_system_prompt(include_learning: bool = True) -> str:
    ...
    """
    return build_system_prompt(False)  # Disable learning - simplified extraction
...
def build_system_prompt(include_learning: bool = True) -> str:
    ...
    # Learning enhancements disabled - simplified extraction
    # if include_learning:
    #     try:
